...
# WYMUŚ InMemory dla wszystkich środowisk (chat działał z tym)
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels.layers.InMemoryChannelLayer'
    }
}
print("Using InMemory channel layer (forced - chat was working)")

# Zakomentowane - Redis może być problemem
